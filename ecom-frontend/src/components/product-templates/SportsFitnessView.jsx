...
export default function SportsFitnessView({ product, allImages, selectedImage, setSelectedImage, handleQuantityChange, quantity, handleAddToCart, isAvailable, variants, selectedVariant, onVariantChange }) {
    return (
